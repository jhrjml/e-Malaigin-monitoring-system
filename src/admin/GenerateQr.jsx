...
const GenerateQR = () => {
  ...
  const downloadIDCard = async () => {
    ...
    try {
      ...
      showToast(
        err.message ||
          "Failed to generate the ID card. If you're offline, try again after opening this page once while online.",
        true,
      );
    } finally {
      setGenerating(false);
          ...
          <div className="qr-layout">
            ...
            {showPreview ? (
              <div className="card preview-card">
                ...
                >
                  Downloading will mark this student as generated and remove
                  them from the list.
                </p>
              </div>
            ) : (
              <div className="card empty-state">
                ...
                <p>
                  Select a student LRN from the dropdown to preview their ID
                  card.
                </p>
              </div>
            )}
